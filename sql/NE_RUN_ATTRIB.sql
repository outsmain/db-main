...
insert into `NE_RUN_ATTRIB`(`ID`,`UPDATE_DATE`,`NE_RUN_TYPE_ID`,`NE_RUN_DATA_ID`,`IP_ADDR`,`ENTRY_ID`,`PARENT_GROUP_ID`,`GROUP_ID`,`ATTRIB_KEY_ID`,`ATTRIB_VALUE`) values (15,'2014-02-20 15:00:00',1,1,'14.23.9.270',2,5,9,2,'04:03:08:03:08:06');
insert into `NE_RUN_ATTRIB`(`ID`,`UPDATE_DATE`,`NE_RUN_TYPE_ID`,`NE_RUN_DATA_ID`,`IP_ADDR`,`ENTRY_ID`,`PARENT_GROUP_ID`,`GROUP_ID`,`ATTRIB_KEY_ID`,`ATTRIB_VALUE`) values (16,'2014-02-20 15:00:00',1,1,'14.23.9.270',2,5,6,1,'14.23.9.282');
