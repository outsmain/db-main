...
<h2>Update ACCESSGROUP <?php echo $model->ACCESSGROUP_ID; ?></h2>
...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="clearfix">
		...
		<?php 
		$row2=Yii::app()->db->createCommand("SELECT  DISTINCT a.ID, STARTTIME, ENDTIME, DOW  FROM ACCESSNAME a JOIN 
		ACCESSGROUP b ON(b.ACCESSNAME_ID =a.ID) WHERE b.ACCESSGROUP_ID ='{$id5}'") ->queryAll();
